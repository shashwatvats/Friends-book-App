...
function Login() {
  ...
  return (
    <div
      style={{ height: "72vh", boxShadow: "0 0 5px 2px" }}
      className="mx-auto col-md-4 mt-4 card ps-3 pe-3"
        ...
        <div className="mb-3">
          ...
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">
              <i style={{ color: "#212529" }} class="fas fa-user"></i>
            </span>
            <input
              type="text"
        ...
        <div className="mb-3">
          ...
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon2">
              <i style={{ color: "#212529" }} class="fas fa-unlock"></i>
            </span>
            <input
              type="password"
